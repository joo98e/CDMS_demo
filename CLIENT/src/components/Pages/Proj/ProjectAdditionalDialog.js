...
export class ProjectAdditionalDialog extends Component {
    constructor(props) {
        super(props)
...
const mapStateToProps = (state) => ({
    projectInfo: state.Producer.projectInfo
})
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withSnackbar(ProjectAdditionalDialog)));