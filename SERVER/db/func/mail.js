...
function fnMail() {
    ...
    for(i = 0; i < _json.length; i++){
        ...
        const numCount = (i + 1);
        const strTopText =        "<div id = 'wrap'>"
                                +   "<span class = 'content'>안녕하세요. <b>미림미디어랩 CDMS</b> 입니다.</span>"
                                +   "<span class = 'content'>" + _json[i].sender + "님이 새로운 게시판을 작성하였습니다.</span>"
                                +   "<span class = 'content'>지금 바로 확인하시려면 <a href = '" + _json[i].url + "'>여기</a>를 눌러주세요.</span>";
        ...
        const strBottomText =       "<span class = 'content'>확인 부탁드리겠습니다.</span>"
                                +   "<span class = 'content'>오늘도 좋은 하루 되세요.</span>"
                                +   "<span class = 'content'>감사합니다.</span>"
                                + "</div>";
